...
describe('Card', () => {
  ...
  it('should 4 h3s and 4 ps', () => {
    ...
    const letterP = wrapper.find('p');

    expect(h3.length).toEqual(4);
    expect(letterP.length).toEqual(4);
  });
  ...
  it('should pass in the correct props', () => {
    ...
    expect(wrapper.props().children[0].props)
      .toHaveProperty('className', 'favorite-btn');
    expect(wrapper.props().children[0].props)
      .toHaveProperty('children', 'Favorite');
    expect(wrapper.props().children[0].props)
